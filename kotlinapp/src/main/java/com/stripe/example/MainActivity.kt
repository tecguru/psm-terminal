...
class MainActivity : AppCompatActivity(), NavigationListener {
  ...
  //  val sharedPref: SharedPreferences = getSharedPreferences(PREF_NAME, PRIVATE_MODE)
     ...
     */
    override fun onRequestPayment(amount: Int, amounttextbox:String, currency: String) {
        navigateTo(EventFragment.TAG, EventFragment.requestPayment(amount,amounttextbox, currency))
    }
